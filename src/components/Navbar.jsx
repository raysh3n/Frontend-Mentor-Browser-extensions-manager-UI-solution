...
export default function Navbar({ theme, onToggleTheme }) {
  ...
  return (
    <nav className="container mx-auto my-5 flex items-center justify-between rounded-xl bg-neutral-50 from-neutral-700 to-neutral-900 p-3 shadow-[rgba(67,71,85,0.27)_0px_0px_0.25em,rgba(90,125,188,0.05)_0px_0.25em_1em] dark:bg-opacity-80 dark:bg-gradient-to-r">
      <a href="#">
        ...
        >
          <g clip-path="url(#a)">
            <path
              fill={theme === "dark" ? "hsl(3, 86%, 64%)" : "#C7231A"}
              fill-rule="evenodd"
